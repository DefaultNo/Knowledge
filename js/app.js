(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".acknowledgements__body")) {
            new core(".acknowledgements__body", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                centeredSlides: true,
                ...
                simulateTouch: false,
                navigation: {
                    prevEl: ".acknowledgements__button_prev",
                    nextEl: ".acknowledgements__button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
    ...
    const menuTarget = document.querySelector(".header__burger");
    ...
    if (document.querySelector(".acknowledgements__slide")) {
        const sliders = document.querySelectorAll(".acknowledgements__slide");
        sliders.forEach((slider => {
            const sliderBody = slider.querySelector(".slide-acknowledgements__body");
            const sliderButton = slider.querySelector(".slide-acknowledgements__button");
            sliderButton.addEventListener("click", (() => {
                sliderBody.classList.add("_active");
            }));
        }));
    }
